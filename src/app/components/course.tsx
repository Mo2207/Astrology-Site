...
export default function Course() {
  ...
  const card4Items= t("course_cards.card4.items", { returnObjects: true }) as string[];
  
  return (
    <section className="flex flex-col items-center gap-12 bg-[#FFFFFF] text-gray-900 py-12">
      
      {/* Card 1 */}
      <div className="h-[30rem] w-[80%] max-w-4xl flex flex-row p-6 rounded-lg border border-black bg-gray-100 hover:bg-gray-200 text-gray-900 overflow-hidden cursor-pointer gap-6">
        {/* Left side */}
        <div className="w-1/2">
          <Image
      ...
      <div className="h-[30rem] w-[80%] max-w-4xl flex flex-row p-6 rounded-lg border border-black bg-gray-100 hover:bg-gray-200 text-gray-900 overflow-hidden cursor-pointer gap-6">
        ...
        <div className="w-1/2 flex flex-col justify-center">
          ...
          <div className="text-center font-medium text-lg text-gray-600 space-y-3">
            <p>{t("course_cards.card2.items")}</p>
          </div>
        </div>
      </div>
